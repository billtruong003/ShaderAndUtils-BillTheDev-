...
namespace Opsive.BehaviorDesigner.Runtime
{
    ...
    public class BehaviorTreeData
    {
        ...
        public bool Deserialize(IGraphComponent graphComponent, IGraph graph, bool force, bool variableForce, bool injectSubtrees, bool canDeepCopyVariables = true, SharedVariableOverride[] sharedVariableOverrides = null)
        {
            ...
            return DeserializeInternal(graphComponent, graph, force, variableForce, injectSubtrees, canDeepCopyVariables, sharedVariableOverrides);
        }
        ...
        /// <param name="sharedVariableOverrides">A list of SharedVariables that should override the current SharedVariable value.</param>
        /// <returns>True if the tree was deserialized.</returns>
        private bool DeserializeInternal(IGraphComponent graphComponent, IGraph graph, bool force, bool variableForce, bool injectSubtrees, bool canDeepCopyVariables, SharedVariableOverride[] sharedVariableOverrides = null)
        {
...
#endif
            DeserializeSharedVariables(variableForce, sharedVariableOverrides);
            PopulateSharedVariablesMapping(graph, force, canDeepCopyVariables, ref m_VariableByNameMap);
        ...
        /// <param name="variableByNameMap">A reference to the map between the VariableAssignment and SharedVariable.</param>
        public static void PopulateSharedVariablesMapping(IGraph graph, bool force, bool canDeepCopy, ref Dictionary<VariableAssignment, SharedVariable> variableByNameMap)
        {
            if (variableByNameMap != null) {
                variableByNameMap.Clear();
            }
            ...
            if (graph.Parent is GameObject parentGameObject) {
                ...
                if (gameObjectSharedVariablesContainer != null) {
                    gameObjectSharedVariablesContainer.Deserialize(force);
            ...
            if (sceneSharedVariablesContainer != null) {
                sceneSharedVariablesContainer.Deserialize(force);
            ...
            if (projectSharedVariablesContainer != null) {
                projectSharedVariablesContainer.Deserialize(force);
        ...
        private static void PopulateSharedVariablesMapping(IGraph graph, SharedVariable[] sharedVariables, SharedVariable.SharingScope scope, bool canDeepCopy, ref Dictionary<VariableAssignment, SharedVariable> variableByNameMap)
        {
            ...
            if (variableByNameMap == null) { variableByNameMap = new Dictionary<VariableAssignment, SharedVariable>(); }
        ...
        public SharedVariable GetVariable(IGraph graph, string name, SharedVariable.SharingScope scope)
        {
            ...
            if (m_VariableByNameMap == null) {
                ...
                PopulateSharedVariablesMapping(graph, false, true, ref m_VariableByNameMap);
            }
        ...
        /// <summary>
        /// Overrides the SharedVariable reference. The name must match an exsting variable.
        /// </summary>
        /// <param name="graph">The graph that the data belongs to.</typeparam>
        /// <param name="variable">The reference to the SharedVariable.</param>
        internal void OverrideVariable(IGraph graph, SharedVariable variable)
        {
