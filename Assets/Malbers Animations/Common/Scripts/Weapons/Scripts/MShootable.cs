...
namespace MalbersAnimations.Weapons
{
    ...
    public class MShootable : MWeapon, IShootableWeapon, IThrower
    {
        ...
        void OnReturnedToPool(GameObject Go)
        {
            ...
            {
                Go.transform.SetParent(this.transform, false); // or to Weapon //CustomPatch: removed redundant gameObject reference
            }
        ...
        #region Events
        //CustomPatch: Added OnBeforeFireProjectile event
