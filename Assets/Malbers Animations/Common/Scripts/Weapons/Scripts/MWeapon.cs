...
namespace MalbersAnimations.Weapons
{
    ...
    public abstract class MWeapon : MDamager, IMWeapon, IMDamager
    {
        ...
        //{
        //    //CustomPatch: SUPER MAJOR ISSUE HERE!!! => DO NOT OVERRIDE Unity objects Equals method unless you REAAALLY understand the consequences. This logic basically kills Unity's default Equals method because this object is a MonoBehaviour.
        //    // Anyone testing if a MWeapon is null to actually check if the weapon is a valid Unity object that has been yet destroyed will actually call this method and only check the weapon IDs which is wrong. => generates SUPER SUPER hard bugs to find!!!
        //    // Added a separate method below for comparing weapon id.
        //    if (a is IMWeapon weapon)
        //        return WeaponID == (a as IMWeapon).WeaponID;

        //    return false;
        //}

        //CustomPatch: removed redundant GetHashCode() method

        //CustomPatch: added replacement method for the above super dangerous overridden Equals method
        ...
        public void Unequip()
        {
            if (!CurrentOwner.IsUnityRefNull())
                CurrentOwner.UnEquip(); //CustomPatch: corrected null check for unity object interface type
        }
    ...
    public abstract class MWeaponEditor : MDamagerEd
    {
        ...
        protected SerializedProperty
            ...
            RidingArmPose, GroundArmPose, groundHandID, //WeaponDirection,
        ...
        protected override void DrawCustomEvents()
        {
            ...
            EditorGUILayout.PropertyField(OnEquipped, new GUIContent("On Equiped by (Owner)"));
