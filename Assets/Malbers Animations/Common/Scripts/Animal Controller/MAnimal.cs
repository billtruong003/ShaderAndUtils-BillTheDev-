...
#pragma warning restore 414
        ...
        void Reset()
        {
            MTools.SetLayer(base.transform, 20);     //Set all the Children to Animal Layer   .
        ...
        void OnDrawGizmos()
        {
            ...
            if (Application.isPlaying)
            {
                ...
                //MDebug.Gizmo_Arrow(pos + Vector3.one*0.1f, InertiaPositionSpeed * 2 * sc);  //Draw the Inertia Direction 
