...
namespace MalbersAnimations.Controller
{
    ...
    public partial class MAnimal
    {
            ...
            if (new_stance != null)
            {
                if (new_stance.CanActivate)
                {
                    ...
                    if (!Sleep) //It may cause issues with the Stances changes while riding
                    {
                        ...
                        else if (LastActiveStance.OverrideCapsule) //If the Last Stance Overrided the Capsule then reset it
                        {
                            Reset_MainCollider();
                        }
                    }
       ...
       // public float ForwardMultiplier { get; set; }
        ...
        ///// <summary>Maximum angle on the terrain the animal can walk </summary>
        //[Range(1f, 90f), Tooltip("Maximum angle on the terrain the animal can walk. If the Terrain Angle is greater than this the animal will stop")]
        ...
        public bool Grounded
        {
            ...
            set
            {
                if (grounded.Value != value)
                {
                    ...
                    if (!value)
                    {
                        SetPlatform(null); //If ground is false remove the stored Platform 
        ...
        public Mode ActiveMode
        {
            ...
            internal set
            {
                ...
                // Debug.Log($"<color=orange><b>ActiveMode:  {(value != null ? "Enter" : "Exit")}  </b></color>"); //Debug Log
                activeMode = value;
