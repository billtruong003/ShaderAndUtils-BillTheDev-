...
namespace MalbersAnimations.Conditions
{
    ...
    public class C2_AnimalDirectionAngle : C2_MAnimal
    {
        ...
        public override string DynamicName => $"Animal Move Direction Angle [{MinAngle.Value}]...[{MaxAngle.Value}]";
        ...
        protected override bool _Evaluate()
        {
            if (Target)
            {
                ...
                float angle = Vector3.SignedAngle(Target.Forward, AxisRaw, Target.UpVector); //Get The angle
