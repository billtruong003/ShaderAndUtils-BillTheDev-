...
namespace MalbersAnimations
{
    ...
    public struct StatModifier
    {
        ...
        public readonly bool ModifyStat(Stats stats, Stats baseStats = null)
        {
            ...
            {
                float baseStatValue = (baseStats != null && Base != null) ? baseStats.Stat_Get(Base).Value : 0f;
    ...
    public class StatModifierDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            EditorGUI.PropertyField(line, Base, new GUIContent("Base", "Base Stat from the owner to increase the value of the target Stat. Leave empty to start from 0.\n E.g. Base Damage of a sword will be extracted from the Owner [Attack] stat, and it will be added to the current modifier value "));


            line.x += position.width * 0.4f + 5;
            ...
            line.x += position.width * 0.4f + 2;
            line.width = position.width * 0.2f - 5;
