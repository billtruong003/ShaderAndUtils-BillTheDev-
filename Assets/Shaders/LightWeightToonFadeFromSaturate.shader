Shader "Custom/URP/LightweightToonFadeDistanceSaturate"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(Varyings input) : SV_Target
            {
                ...
                // Tính toán hệ số fade: 0 khi gần (_FadeEndDistance), 1 khi xa (_FadeStartDistance)
                // Các giá trị trung gian sẽ được nội suy.
