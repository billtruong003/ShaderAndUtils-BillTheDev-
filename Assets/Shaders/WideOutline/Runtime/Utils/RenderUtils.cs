...
namespace BillTheDev.BillOutline.Common.Utils
{
        ...
        public static (int, int) GetSrcDstBlend(BlendingMode blendMode)
        {
            ...
            switch (blendMode)
            {
                case BlendingMode.Alpha:
                    blending.Item1 = (int)UnityEngine.Rendering.BlendMode.SrcAlpha;
                    blending.Item2 = (int)UnityEngine.Rendering.BlendMode.OneMinusSrcAlpha;
                    break;
                case BlendingMode.Premultiply:
                    blending.Item1 = (int)UnityEngine.Rendering.BlendMode.One;
                    blending.Item2 = (int)UnityEngine.Rendering.BlendMode.OneMinusSrcAlpha;
                    break;
                case BlendingMode.Additive:
                    blending.Item1 = (int)UnityEngine.Rendering.BlendMode.One;
                    blending.Item2 = (int)UnityEngine.Rendering.BlendMode.One;
                    break;
                case BlendingMode.SoftAdditive:
                    blending.Item1 = (int)UnityEngine.Rendering.BlendMode.OneMinusDstColor;
                    blending.Item2 = (int)UnityEngine.Rendering.BlendMode.One;
                    break;
                default:
