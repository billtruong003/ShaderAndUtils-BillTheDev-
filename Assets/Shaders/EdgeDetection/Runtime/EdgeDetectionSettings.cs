...
{
    [CreateAssetMenu(fileName = "Edge Detection Settings", menuName = "BillTheDev/Edge Detection Settings")]
    [Icon("Assets/Shaders/BillTheDev/Editor/Icons/EdgeDetection.png")]
