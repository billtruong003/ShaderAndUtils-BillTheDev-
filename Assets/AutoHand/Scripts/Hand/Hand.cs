...
namespace Autohand
{
    ...
    public class Hand : HandBase
    {
        ...
        [Button("Auto Detect Hand")]
        [ContextMenu("Auto Detect Hand")]
        public void AutoDetectHand()
        {
            if (left)
            {
                SetLayerRecursive(transform, LayerMask.NameToLayer(leftHandLayerName));
            }
            else
            {
                SetLayerRecursive(transform, LayerMask.NameToLayer(rightHandLayerName));
            }
        }

        [Button("Auto Detect Fingers")]
        [ContextMenu("Auto Detect Fingers")]
        public void AutoDetectFingers()
        {
            fingers = GetComponentsInChildren<Finger>(true);
        }
