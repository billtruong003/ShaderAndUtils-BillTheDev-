                ...
                if (i % 3 == 0)
                {
...
#else
                        var fmh_249_78_638908046303712404 = Quaternion.identity; newTargetPosition = Handles.FreeMoveHandle(pointPos, size * .3f, Vector3.zero, Handles.SphereHandleCap);
#endif
...
#else
                        var fmh_265_78_638908046303716068 = Quaternion.identity; newTargetPosition = Handles.FreeMoveHandle(pointPos, size * .2f, Vector3.zero, Handles.SphereHandleCap);
#endif
                    ...
                    else
                    {
                        ...
                        else if (showGizmo || !showGizmo && isShowTangent)
                        {
                            ...
                            newTargetPosition = Handles.FreeMoveHandle(pointPos, size * .3f, Vector3.zero, Handles.SphereHandleCap); 
#else
                                var fmh_290_86_638908046303720783 = Quaternion.identity; newTargetPosition = Handles.FreeMoveHandle(pointPos, size * .3f, Vector3.zero, Handles.SphereHandleCap);
#endif
                            ...
                            newTargetPosition = Handles.FreeMoveHandle(pointPos, size * .2f, Vector3.zero, Handles.SphereHandleCap); 
#else
                                var fmh_299_86_638908046303724175 = Quaternion.identity; newTargetPosition = Handles.FreeMoveHandle(pointPos, size * .2f, Vector3.zero, Handles.SphereHandleCap);
#endif
...
#else
                            var fmh_335_82_638908046303728045 = Quaternion.identity; newTargetPosition = Handles.FreeMoveHandle(pointPos, size * .1f, Vector3.zero, Handles.SphereHandleCap);
#endif
