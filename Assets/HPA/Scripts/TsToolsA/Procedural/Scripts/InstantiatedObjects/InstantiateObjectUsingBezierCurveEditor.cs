...
#else
                var fmh_506_130_638908046301533634 = Quaternion.identity; Handles.FreeMoveHandle(OBC.distVecListPlusOffsetFinal[m_startPathPos.intValue].spotPos + OBC.transform.position, size * .1f, Vector3.zero, Handles.SphereHandleCap); ;
#endif
...
#else
                var fmh_512_128_638908046301537457 = Quaternion.identity; Handles.FreeMoveHandle(OBC.distVecListPlusOffsetFinal[m_endPathPos.intValue].spotPos + OBC.transform.position, size * .1f, Vector3.zero, Handles.SphereHandleCap);
#endif
            }
            #endregion
        }
