...
//This content is under Creative Commons Attribution Share Alike license.
...
public class CreatePlaneTEM : ScriptableWizard
{
	...
	static void CreateWizard()
	{
		...
		if (!cam)
			...
			lastUsedCam = cam;
		ScriptableWizard.DisplayWizard("Create Plane", typeof(CreatePlaneTEM));
	}
	...
	void OnWizardCreate()
	{
		...
		string meshPrefabPath = "Assets/ARTnGAME/Toon Effects Maker/Planes/" + plane.name + widthSegments + "x" + lengthSegments + "W" + width + "L" + length + (orientation == Orientation.Horizontal? "H" : "V") + ".asset";
