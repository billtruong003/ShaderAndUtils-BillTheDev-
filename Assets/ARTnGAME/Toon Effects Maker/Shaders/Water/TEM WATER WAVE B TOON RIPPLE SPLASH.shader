...
Shader "Toon Effects Master/Toon Water Waves Ripple Splash" {
    Properties {
...
////// Emissive:
                ...
                float4 _Diffuse_var = tex2D(_Diffuse,TRANSFORM_TEX(i.uv0*(3-sin(node_50271 + 1.5*i.uv0*pi)), _Diffuse)+ t.xy*0.5+d*p.xy*0.0000003 ); //t.xy defines speed, 1.000000003 defines tiling
                float node_8608 = 0.1;
