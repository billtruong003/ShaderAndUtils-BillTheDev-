...
namespace Artngame.GLAMOR.VolFx
{
    ...
    public class PencilVolFxPass : VolFxProc.Pass
    {        
        ...
        PencilVolFxVol settings;

        public override bool Validate(Material mat)
        {
            if (settings == null)
            {
                settings = Stack.GetComponent<PencilVolFxVol>();
            }
            ...
            , RenderTextureDescriptor descA, bool isRG)
        {
            ...
            if (_materialA == null)
            {
                _materialA = Resources.Load<Material>("PencilVolFx");
            }
            if (_materialA == null)
            {
                _materialA = new Material(Resources.Load<Shader>("PencilVolFx"));
            }
