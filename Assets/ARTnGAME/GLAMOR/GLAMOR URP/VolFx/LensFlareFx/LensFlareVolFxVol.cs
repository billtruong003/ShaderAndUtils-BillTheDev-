...
namespace Artngame.GLAMOR.VolFx
{
    ...
    [Serializable, VolumeComponentMenu("VolFx/LensFlareVolFx")]
    public sealed class LensFlareVolFxVol : VolumeComponent, IPostProcessComponent
    {
        public NoInterpFloatParameter Subtract = new NoInterpFloatParameter(0.0f);
        [Range(0, 1)]
        public NoInterpFloatParameter Multiply = new NoInterpFloatParameter(1);
        [Range(0, 6)]
        public NoInterpIntParameter Downsample = new NoInterpIntParameter(1);
        [Range(0, 8)]
        public NoInterpIntParameter NumberOfGhosts = new NoInterpIntParameter(5);
        [Range(0, 2)]
        public NoInterpFloatParameter Displacement = new NoInterpFloatParameter(0.5f);
        public NoInterpFloatParameter Falloff = new NoInterpFloatParameter(8);
        [Range(0, 0.5f)]
        public NoInterpFloatParameter HaloWidth = new NoInterpFloatParameter(0.5f);
        public NoInterpFloatParameter HaloFalloff = new NoInterpFloatParameter(36);
        public NoInterpFloatParameter HaloSubtract = new NoInterpFloatParameter(0.1f);

        [Range(0, 64)]
        public NoInterpIntParameter BlurSize = new NoInterpIntParameter(16);
        [Range(1, 16)]
        public NoInterpFloatParameter Sigma = new NoInterpFloatParameter(8);

        [Range(0, 0.1f)]
        public NoInterpFloatParameter chromaticAberration = new NoInterpFloatParameter(0.01f);
        public Texture2DParameter chromaticAberrationSpectrum = new Texture2DParameter(null);

        //public enum ChromaticAberrationDistanceFunction : int
        //{
        //    Linear = 0, Sqrt = 1, Constant = 2
        //}
        public NoInterpIntParameter chromaticAberrationDistanceFunction = new NoInterpIntParameter(0);
