...
namespace Artngame.GLAMOR.VolFx
{
    public static class Utils
    {
        ...
        //public static void BlitNoMat(CommandBuffer cmd, RTHandle source, RTHandle destination)
        //{
        //    cmd.Blit(source.rt, destination.rt);
        //}
        public static void BlitRT(CommandBuffer cmd, RenderTexture source, RenderTexture destination, Material material, int pass = 0, bool invert = false)
        {
            cmd.SetGlobalTexture(s_MainTexId, source);
            cmd.SetRenderTarget(destination, 0);
            cmd.DrawMesh(FullscreenMesh, invert ? s_IndentityInvert : Matrix4x4.identity, material, 0, pass);
        }
        public static void BlitRTA(CommandBuffer cmd, RTHandle source, RenderTexture destination, Material material, int pass = 0, bool invert = false)
        {
            cmd.SetGlobalTexture(s_MainTexId, source.nameID);
            cmd.SetRenderTarget(destination, 0);
            cmd.DrawMesh(FullscreenMesh, invert ? s_IndentityInvert : Matrix4x4.identity, material, 0, pass);
        }
        public static void JustBlit(CommandBuffer cmd, RenderTexture source, RenderTexture destination)//RTHandle source, RTHandle destination)
        {
            //cmd.SetGlobalTexture(s_MainTexId, source);
            //cmd.SetRenderTarget(destination, 0);
        ...
        public static void JustBlitA(CommandBuffer cmd, RenderTexture source, RTHandle destination)//RTHandle source, RTHandle destination)
        {
            //cmd.SetGlobalTexture(s_MainTexId, source);
            //cmd.SetRenderTarget(destination, 0);
            cmd.Blit(source, destination.rt);
            //cmd.DrawMesh(FullscreenMesh, invert ? s_IndentityInvert : Matrix4x4.identity, material, 0, pass);
        }
        public static void JustBlitB(CommandBuffer cmd, RenderTexture source, RenderTexture destination, Material material, int pass = 0)//RTHandle source, RTHandle destination)
        {
            //cmd.SetGlobalTexture(s_MainTexId, source);
            //cmd.SetRenderTarget(destination, 0);
        ...
        public static void JustBlitC(CommandBuffer cmd, RTHandle source, RTHandle destination, Material material, int pass = 0)//RTHandle source, RTHandle destination)
        {
            //cmd.SetGlobalTexture(s_MainTexId, source);
            //cmd.SetRenderTarget(destination, 0);
            cmd.Blit(source.nameID, destination, material, pass);
            //cmd.DrawMesh(FullscreenMesh, invert ? s_IndentityInvert : Matrix4x4.identity, material, 0, pass);
        }
