Shader "Unlit/VolumeHazyFogFx_URP_RG_FBM_ImpostorsA"
{
...
#pragma multi_compile _ USE_SKYBOX
	...
	Pass //PASS 7
	{
			...
			Pass
		{
			...
			// 11: First level downsampler with anti-flicker
			Pass
		{
			ZTest Always Cull Off ZWrite Off
			CGPROGRAM
