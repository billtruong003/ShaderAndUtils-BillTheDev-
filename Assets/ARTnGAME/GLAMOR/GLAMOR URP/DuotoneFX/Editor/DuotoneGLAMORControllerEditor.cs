...
namespace Artngame.GLAMOR.Duotone.Editor {

[CustomEditor(typeof(DuotoneGLAMORController))]
sealed class DuotoneGLAMORControllerEditor : UnityEditor.Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(DuoToneStrength);
