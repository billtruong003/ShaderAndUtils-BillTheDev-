...
{
    internal class BakeAOStandardShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent occlusionUVSet = EditorGUIUtility.TrTextContent("Occlusion UV Set", "Occlusion UV Set");
            public static GUIContent multiplyOcclusionWithDiffuse = EditorGUIUtility.TrTextContent("Apply AO to diffuse", "Multiply diffuse and occlusion");
        ...
        MaterialProperty aoTextureUV = null;
        MaterialProperty multiplyAlbedoAndOcclusion = null;
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            aoTextureUV = FindProperty("_AOTextureUV", props);
            multiplyAlbedoAndOcclusion = FindProperty("_MultiplyAlbedoAndOcclusion", props);
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                m_MaterialEditor.ShaderProperty(aoTextureUV, Styles.occlusionUVSet.text);
                m_MaterialEditor.ShaderProperty(multiplyAlbedoAndOcclusion, Styles.multiplyOcclusionWithDiffuse.text);
        ...
        void DoNormalArea()
        {
            ...
            if (bumpScale.floatValue != 1
                && (EditorUserBuildSettings.activeBuildTarget == BuildTarget.Android || EditorUserBuildSettings.activeBuildTarget == BuildTarget.iOS))
