...
Shader "Procedural Pixels/Bake AO - URP/Simple Lit"
{
    ...
    Properties
    {
        ...
        _MultiplyAlbedoAndOcclusion("Apply AO to albedo", Float) = 1.0
        _AOTextureUV("AO UV channel", Float) = 1.0
        // BakeAO add end
    ...
    CustomEditor "ProceduralPixels.BakeAO.Editor.URPSimpleLitShaderGUI_BakeAOSupport"
}
